...
function handleLogin(type) {
    ...
    if (type === 'developer') {
        headerNav.innerHTML = `
            <button onclick="switchView('editor')" class="nav-btn">💻 Editor</button>
            <button onclick="switchView('library')" class="nav-btn">📚 Library</button>
            <button onclick="logout()" class="btn-logout">🚪 Logout</button>
        `;
        switchView('editor');
    } else {
        headerNav.innerHTML = `
            <button onclick="switchView('library')" class="nav-btn">📚 Components</button>
            <button onclick="switchView('builder')" class="nav-btn">🎨 Builder</button>
            <button onclick="logout()" class="btn-logout">🚪 Logout</button>
        `;
        switchView('library');
    }
